...
public class Asegurado extends Paciente {
    public String TagAsegurado = "asegurado";
    public String TagPoliza = "poliza";
    public String TagCompanhia = "companhia";
    ...
    public Asegurado(Element e) throws ParsingException {
        ...
        if(eltoPoliza == null){
            ...
            throw  new ParsingException("falta la poliza en el elemento");
        }
        ...
        if(eltoCompanhia == null){
            ...
            throw  new ParsingException("falta la companhia en el elemento");
        }
        this.companhia = eltoCompanhia.getValue();
    }
   ...
   /** Cambia la compañia del paciente
    ...
    public Element toDOM() {
        ...
        eltoPoliza.appendChild(companhia);

        toret.setLocalName(TagAsegurado);
        toret.appendChild(eltoPoliza);
        toret.appendChild(eltoCompanhia);
        return toret;
    }
}
