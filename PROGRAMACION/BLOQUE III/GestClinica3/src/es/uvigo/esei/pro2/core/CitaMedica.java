...
public class CitaMedica {
    ...
    private String TagPaciente ="paciente";
    private String TagMedico ="medico";
    private String TagFechaCita ="fechaCita";
    private String TagHoraCita ="horaCita";
